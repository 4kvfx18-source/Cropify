// FIX: Implemented the CanvasEditor component to handle image display, selection drawing, and cropping logic. This resolves the errors caused by the missing file content.
